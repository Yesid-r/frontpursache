            ...
            <div className='w-full px-8 md:px-32 lg:px-24'>
                <form class="bg-white rounded-md shadow-2xl p-5 mt-3 max-w-md mx-auto" >
                    ...
                    <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                        ...
                        <input id="name" className=" pl-2 w-full outline-none border-none" type="text" name="name" placeholder={dataCustomerModify ? dataCustomerModify.name : 'Nombre'} onChange={(e) => { setName(e.target.value) }} />
                    </div>
